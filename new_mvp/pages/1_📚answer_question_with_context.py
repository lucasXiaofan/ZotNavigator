...
with st.sidebar:
    ...
    st.subheader("✒️Change your context")
    major: str = st.selectbox("major", options=major)
    year: str = st.selectbox("year", options=profile_year)
    addtag = st.text_input("add tag")
    deletetag = st.text_input("delete tag")
st.title("💬 ZotNavigator") 
st.write(
    """
    feedback feature is not yet implement
    """
)
# tab1, tab2, tab3, tab4 = st.tabs([
#     "🚀 Q&A with context",
#     "🐢 get recommendation list with profile",
#     "✒️ update user profile with conversation",
